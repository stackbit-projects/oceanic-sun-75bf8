...
1. Run the following command to fetch the content from Sanity:
        ...
        npx @stackbit/stackbit-pull --stackbit-pull-api-url=https://api.stackbit.com/pull/60475bf8ae06af001892047d
...
To start editing your site, you can use the Sanity interface at https://oceanic-sun-75bf8.sanity.studio/.
...
Generated at `2021-03-09T11:29:16.380Z` by Stackbit version `0.3.50`.